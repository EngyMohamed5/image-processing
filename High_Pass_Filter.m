function output_image = High_Pass_Filter(input_image)
    ...
    H = 1 - exp(-(D.^2) / (2 * cutoff_frequency^2));  % Gaussian High Pass Filter
    ...
    subplot(1, 2, 2), imshow(output_image, []), title('High Pass Filtered Image');
end
