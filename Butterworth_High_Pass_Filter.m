function output_image = Butterworth_High_Pass_Filter(input_image)
    ...
    % Step 3: Create the Butterworth High Pass Filter
    ...
    H = 1 ./ (1 + (cutoff_frequency ./ D).^(2 * order));  % Butterworth High Pass Filter equation
    ...
    subplot(1, 2, 2), imshow(output_image, []), title('Butterworth High Pass Filtered Image');
end
